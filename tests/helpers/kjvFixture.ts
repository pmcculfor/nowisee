  ...
  dictionaryEntries: [
    {
      ...
      lemma: "רֵאשִׁית",
      translit: "reshith",
      body: "the first, in place, time, order or rank",
    },
    {
      workId: "strongs",
      strongs: "H430",
      lemma: "אֱלֹהִים",
      translit: "elohim",
      body: "gods in the ordinary sense; but specifically used of the supreme God",
    },
    {
      workId: "strongs",
      strongs: "G25",
      lemma: "ἀγαπάω",
      translit: "agapao",
      body: "to love (in a social or moral sense)",
    },
  ],
  tokens: [
    {
